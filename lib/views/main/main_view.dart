...
class MainBinding implements Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut(() => HomeLogic(Get.find(), Get.find(), Get.find()));
    Get.lazyPut(() => ExploreLogic(Get.find(), Get.find()));
    ...
    return WillPopScope(
      onWillPop: () async {
        showConfirmationDialog(
            onConfirmed: () => SystemNavigator.pop(),
            context: context,
            title: 'Confirm',
            message: "Do you want to close app ?");
        return false; // luôn return false để chặn pop mặc định
      },
      child: Scaffold(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              stops: [
                ...
                0.5,
                1.0
              ], // Điều chỉnh điểm dừng để gradient mượt mà
            ),
            boxShadow: [
              BoxShadow(
