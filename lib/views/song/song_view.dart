...
class SongView extends GetView<SongLogic> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        final gradientColors = controller.getGradientColors(controller.progress.value.clamp(0.0, 1.0));

        return AnimatedContainer(

          duration: const Duration(milliseconds: 100), // Thời gian chuyển màu mượt mà
            ...
            child: ListView(
              ...
              children: [
                  ...
                  children: [
                    ...
                    IconButton(
                      onPressed: () => Get.toNamed(Routes.menu.p,
                          arguments: controller.songController.state.song.value),
                      icon: const Icon(
                    ...
                    children: [
                      Align(
                        ...
                        child: Container(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(5),
                            child: Image.asset(
                              controller.songController.state.song.value!.coverImage
                                  .isEmpty
                                  ? 'assets/images/img1.jpg'
                                  : controller
                                  .songController.state.song.value!.coverImage,
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                      ...
                      controller.isReady.value
                        ...
                        child: AudioFileWaveforms(
                          ...
                          size: Size(MediaQuery.of(context).size.width - 52, 60),
                ...
                Obx(
                    ...
                    child: PrimaryText(
                      text: (controller
                          .songController.state.song.value!.title.isNotEmpty)
                ...
                Obx(
                    ...
                    child: Row(
                      ...
                      children: [
                        PrimaryText(
                          text: (controller.songController.state.song.value!.artist
                              .isNotEmpty)
                              ? controller.songController.state.song.value!.artist
                              : 'Unknown Artist',
                          color: Colors.white,
                        ),
                        Row(
                ...
                Obx(() {
                  final max = controller.duration.value.inMilliseconds.toDouble();
